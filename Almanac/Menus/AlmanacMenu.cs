...
public class AlmanacMenu : IClickableMenu {
	...
	public void SetErrorState() {
		...
		SetRightFlow(FlowHelper.Builder()
			.Texture(Game1.mouseCursors, new Rectangle(268, 470, 16, 16), 3f, align: Alignment.Center | Alignment.HCenter)
			.Text(" ")
			.FormatText(I18n.Page_Error(), font: Game1.dialogueFont, align: Alignment.Center)
			.Text("\n\n")
