...
namespace Leclair.Stardew.Common
{
    public static class GameStateQuery {
		...
		private static void Initialize() {
			...
			RegisterCondition("PLAYER_COMBAT_LEVEL", args => {
			...
			RegisterCondition("PLAYER_FARMING_LEVEL", args => { 
				int level = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_FISHING_LEVEL", args => {
				int level = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_FORAGING_LEVEL", args => { 
				int level = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_MINING_LEVEL", args => {
				int level = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_CURRENT_MONEY", args => {
			...
			RegisterCondition("PLAYER_FARMHOUSE_UPGRADE", args => { 
				int level = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_HAS_ACHIEVEMENT", args => { 
			...
			RegisterCondition("PLAYER_HAS_CAUGHT_FISH", args => {
				int fish = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_HAS_DIALOGUE_ANSWER", args => { 
				int id = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_HAS_FLAG", args => {
				string flag = string.Join(' ', args[1..]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
					farmer.hasOrWillReceiveMail(flag)
				);
			});

			RegisterCondition("PLAYER_HAS_ITEM", args => {
				int id = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_HAS_ITEM_NAMED", args => {
			...
			RegisterCondition("PLAYER_HAS_PROFESSION", args => {
				int id = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
					farmer.professions.Contains(id)
				);
			});

			RegisterCondition("PLAYER_HAS_READ_LETTER", args => {
				string flag = string.Join(' ', args[1..]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_HAS_SECRET_NOTE", args => {
				int id = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
					farmer.secretNotesSeen.Contains(id)
				);
			});

			RegisterCondition("PLAYER_HAS_SEEN_EVENT", args => {
				int id = int.Parse(args[1]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
					farmer.eventsSeen.Contains(id)
				);
			});
			...
			RegisterCondition("PLAYER_LOCATION_NAME", args => {
				string name = string.Join(' ', args[1..]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_LOCATION_UNIQUE_NAME", args => {
				string name = string.Join(' ', args[1..]);
				return state => CheckMatchingPlayers(args[0], state, farmer =>
			...
			RegisterCondition("PLAYER_HAS_CHILDREN", args => {
