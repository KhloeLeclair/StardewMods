...
public interface IBetterGameMenu {
	...
	/// <summary>
	/// This event fires whenever the current tab changes.
	/// </summary>
	event EventHandler<(string Tab, string OldTab)> OnTabChanged;
	...
	/// page instance.
	/// </summary>
	event EventHandler<(string Tab, string Source, IClickableMenu Page, IClickableMenu? OldPage)> OnPageInstantiated;
}
...
public interface IBetterGameMenuApi {
	...
	/// <summary>
	/// Try to get the currently active menu as an <see cref="IBetterGameMenu"/>
	/// if the currently active menu is one.
	/// </summary>
	/// <param name="menu">The active menu, if it's a Better Game Menu.</param>
	/// <returns>Whether or not the active menu is a Better Game Menu.</returns>
	bool TryGetActiveMenu([NotNullWhen(true)] out IBetterGameMenu? menu);

	/// <summary>
	/// Try to cast a <see cref="IClickableMenu"/> into a <see cref="IBetterGameMenu"/>.
	...
	/// <param name="castMenu">The result of the cast</param>
	/// <returns>Whether or not the menu was a Better Game Menu.</returns>
	bool TryGetMenu(IClickableMenu menu, [NotNullWhen(true)] out IBetterGameMenu? castMenu);

	/// <summary>
	/// Try to open a Better Game Menu. This will only work if a game menu can
	/// be opened for the active screen.
	/// </summary>
	/// <param name="menu">The menu that was opened, if one was.</param>
	...
	/// <returns>Whether or not a game menu was opened.</returns>
	bool TryOpenMenu(
		[NotNullWhen(true)] out IBetterGameMenu? menu,
	...
	/// <summary>
	/// This event fires whenever the game menu is instantiated, at the end of
	...
	/// </summary>
	event EventHandler<IClickableMenu> OnMenuInstantiated;

	/// <summary>
	/// This event fires whenever the current tab changes, excepting when a
	/// game menu is first instantiated.
	/// </summary>
	event EventHandler<(IClickableMenu Menu, string Tab, string OldTab)> OnTabChanged;
	...
	/// page instance.
	/// </summary>
	event EventHandler<(IClickableMenu Menu, string Tab, string Source, IClickableMenu Page, IClickableMenu? OldPage)> OnPageInstantiated;
